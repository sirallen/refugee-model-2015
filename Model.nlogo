;; Allen Sirolly
;; Political Science 418 Final Project
;; May 4, 2015
;; sirallen@sas.upenn.edu
...
1172
189
Total Displaced Persons (not refugees)
IDPs
3
1
11
...
<experiments>
  ...
  <experiment name="get time series (one trial)" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>refugees</metric>
